<?php
	...
	// 7:58 PM
	// 4/13/22
	// /ClientAppSettings/index.php
	// Gets all of the settings for WindowsPlayer/Studio
	
	// Set the Content-Type header
	header("Content-Type: application/json");
	
	// Define the main array
  // Do we even need DFStringHttpInfluxURL to have an AWS URL? TODO: Check this.
	$array = [
	   ...
	   "DFStringHttpInfluxURL" => "http://ec2-52-8-11-103.us-west-1.compute.amazonaws.com:8086",
